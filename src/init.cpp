...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/nanakshahiworld/nanakshahicoin-core>";
    const std::string URL_WEBSITE = "<https://nanakshahicoin.com>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Nanakshahicoin version %s\n", FormatFullVersion());
}
