...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s nanakshahicoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  nanakshahicoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded nanakshahicoin transaction") + "\n" +
              "  nanakshahicoin-tx [options] -create [commands]   " + _("Create hex-encoded nanakshahicoin transaction") + "\n" +
              "\n";
